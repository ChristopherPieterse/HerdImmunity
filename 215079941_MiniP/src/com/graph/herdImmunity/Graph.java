...
public class Graph<T extends Comparable<T>> implements Serializable {
	...
	private int numVacc, numUn, numInf;
	private double perUnInf;
	...
	public int getNumVacc() {
		return numVacc;
	}

	public void setNumVacc(int numVacc) {
	...
	public double getPerUnInf() {
		return perUnInf;
	}

	public void setPerUnInf(double perUnInf) {
		this.perUnInf = perUnInf;
	}
	...
	public Graph(Graph<T> g) {
		...
		numVacc = g.getNumVacc();
		numUn = g.getNumUn();
		numInf = g.getNumInf();
		perUnInf = g.getPerUnInf();
		dayNum = g.getDayNum();
